	...
	function loadHostState(){
		var url = 'ajax/get_host_state?host_id=' + document.getElementsByName('host_id')[0].value;
	...
	function setHostState(){
		...
		var url = 'ajax/set_host_state?host_id=' + document.getElementsByName('host_id')[0].value;
